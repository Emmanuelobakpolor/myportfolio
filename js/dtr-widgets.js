( function( $ ) {
   ...
   var WidgetTestimonialHandler3Col = function( $scope, $ ) {
	...
	// Posts Grid
	var WidgetPostsGridHandler = function( $scope, $ ) {
		var dtr_posts_grid = $scope.find('.dtr-post-ele-grid');
		dtr_posts_grid.imagesLoaded( function () {
			dtr_posts_grid.isotope( 
			{
				itemSelector: '.dtr-post-ele-grid-item',
				masonry: {},
				layoutMode : 'fitRows',
			});
		});
	}; // WidgetPostsGridHandler
	...
	$( window ).on( 'elementor/frontend/init', function() {
		...
		elementorFrontend.hooks.addAction( 'frontend/element_ready/dtr-posts-grid.default', WidgetPostsGridHandler );
